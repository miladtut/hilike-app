...
import 'package:hilike/Pages/ForgotPass/After_forget_pass.dart';
import 'package:hilike/Pages/ForgotPass/Verification3.dart';
...
class Verification2 extends StatefulWidget {
  ...
  Verification2({this.email, required this.isFromSignup, required this.code});
                  ...
                  await Navigator.pushAndRemoveUntil(
                    ...
                    MaterialPageRoute(
                        builder: (BuildContext context) =>
                            Mainmenu(fromPage: "new")),
                    ModalRoute.withName('/'),
                  );
                } else {
                  AfterPass(code: widget.code).launch(context);
                }
              },
              child: Container(
