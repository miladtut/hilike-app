...
class RegProfilephoto extends StatefulWidget {
  ...
  @override
  _RegProfilephotoState createState() => _RegProfilephotoState();
}

class _RegProfilephotoState extends State<RegProfilephoto> {
