...
class MessageSupportWidget extends StatelessWidget {
  final MessageSupport message;
  ...
  Widget buildMessage() => Column(
        ...
        children: <Widget>[
            ...
            isMe
                ? Row(
                    ...
                    children: [
                      ...
                      Text(
                        TimeAgo.chatTimeAgo(message.createdAt.toLocal(),
                            locale: locale),
                        style: TextStyle(
          ...
          if (message.type == 0 || message.type == -1) SizedBox(height: 8)
        ],
      );
}
